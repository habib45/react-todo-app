...
const TaskList = ({ toggleForm }) => {
  const { tasks, updateTaskStatus, setEditingTask, deleteTask } =
  ...
  return (
    <div className="col-md-12 taskListTable border border-light p-2">
            ...
            {tasks.map((t) => (
              <tr key={t.id}>
                ...
                <td>
                  ...
                  <br />
                  <small>
                    <div dangerouslySetInnerHTML={{ __html: t.details }} />
                  </small>
                </td>
                ...
                <td className="project-actions text-right">
                  <select
                    value={t.status}
                    onChange={(event) => handleStatusChange(t.id, event)}
                    className=" me-1"
                  >
